...
html_theme_options = {
    ...
    "light_css_variables": {
        "color-brand-primary": "#5B63D3",
        "color-brand-content": "#5B63D3",
        ...
        "font-stack--headings": "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif",
    },
    "dark_css_variables": {
        "color-brand-primary": "#8B93FF",
        "color-brand-content": "#8B93FF",
    },
    "footer_icons": [
        {
            "name": "GitHub",
...
mathjax_path = "https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-AMS-MML_SVG"
